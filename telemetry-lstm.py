...
pyplot.legend()
pyplot.title('Model loss (rnn:%s unit:%s epoch:%s batch:%s)' % (rnn, unit, epoch, batch))
pyplot.ylabel('loss')
pyplot.xlabel('epoch')
...
pyplot.legend()
pyplot.title('Model accuracy (rnn:%s unit:%s epoch:%s batch:%s)' % (rnn, unit, epoch, batch))
...
pyplot.legend()
pyplot.title('Prediction result RMSE:%.3f rnn:%s unit:%s epoch:%s batch:%s' % (rmse, rnn, unit, epoch, batch))
